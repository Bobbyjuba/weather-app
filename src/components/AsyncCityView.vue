...
const getWeatherData = async () => {
  try {
    const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=0afef796c2d00bde5337fb3e0bfb80ed&units=imperial`);
    
    // Below is for handling differences between the user's time zone and the
    // timezone of the data requested
    ...
    // Flicker delay when loading specific city details... might remove
